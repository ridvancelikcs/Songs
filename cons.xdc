...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {JBO[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBO[0]}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {JBO[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBO[1]}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {JBO[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBO[2]}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {JBO[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBO[3]}]
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {JBI[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBI[0]}]
#	set_property PULLDOWN true [get_ports JBI[0]]
##Sch name = JB8
#set_property PACKAGE_PIN A17 [get_ports {JBI[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBI[1]}]
#    set_property PULLDOWN true [get_ports JBI[1]]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports {JBI[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBI[2]}]
#	set_property PULLDOWN true [get_ports JBI[2]]
##Sch name = JB10 
#set_property PACKAGE_PIN C16 [get_ports {JBI[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JBI[3]}]
#	set_property PULLDOWN true [get_ports JBI[3]]
 


##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {sound}]					
